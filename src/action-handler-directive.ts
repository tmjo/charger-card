...
customElements.define('action-handler-charger-card', ActionHandler);

const getActionHandler = (): ActionHandler => {
  const body = document.body;
  if (body.querySelector('action-handler-charger-card')) {
    return body.querySelector('action-handler-charger-card') as ActionHandler;
  }

  const actionhandler = document.createElement('action-handler-charger-card');
