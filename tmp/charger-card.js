...
const MAIN_ENTITY_BASE$3 = '_status'; //OVERRIDE CARD CONFIG WHEN BRAND TEMPLATE SELECTED (for instance turn off leds if they don't make any sense)
...
//Defines what should be replaced from main entity name to use as template for other entities
const MAIN_ENTITY_BASE$2 = '_status'; //OVERRIDE CARD CONFIG WHEN BRAND TEMPLATE SELECTED (for instance turn off leds if they don't make any sense)
...
/** OpenEVSE */
//Defines what should be replaced from main entity name to use as template for other entities
const MAIN_ENTITY_BASE = '_charging_status'; //OVERRIDE CARD CONFIG WHEN BRAND TEMPLATE SELECTED (for instance turn off leds if they don't make any sense)
